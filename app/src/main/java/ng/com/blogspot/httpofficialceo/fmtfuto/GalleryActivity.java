...
import ng.com.blogspot.httpofficialceo.fmtfuto.cards.SliderAdapter;
import ng.com.blogspot.httpofficialceo.fmtfuto.utils.DecodeBitmapTask;
...
//        country2TextView.setTypeface(Typeface.createFromAsset(getAssets(), "open-sans-extrabold.ttf"));
    ...
    private void onActiveCardChange(int pos) {
        ...
        clockSwitcher.setInAnimation(GalleryActivity.this, animV[0]);
        clockSwitcher.setOutAnimation(GalleryActivity.this, animV[1]);
    ...
    private class TextViewFactory implements  ViewSwitcher.ViewFactory {
        ...
        public View makeView() {
            final TextView textView = new TextView(GalleryActivity.this);
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                textView.setTextAppearance(GalleryActivity.this, styleId);
            } else {
    ...
    private class OnCardClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (clickedPosition == activeCardPosition) {
                final Intent intent = new Intent(GalleryActivity.this, DetailsActivity.class);
               // intent.putExtra(DetailsActivity.BUNDLE_IMAGE_ID, pics[activeCardPosition % pics.length]);
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ...
                    final ActivityOptions options = ActivityOptions
                            .makeSceneTransitionAnimation(GalleryActivity.this, sharedView, "shared");
